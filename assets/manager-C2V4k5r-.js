import"./style-D84SsKEL.js";import{t as e}from"./navbar-8TJY0WqY.js";import{n as t}from"./accountSwitcher-DSipr2h4.js";import{t as n}from"./db-CAIJAptv.js";import{a as r,n as i,r as a,s as o}from"./bookings-PBa46hCe.js";import{t as s}from"./bookingSidebar-DRkGenzl.js";e(document.getElementById(`site-navbar-mount`),{basePath:`../`,showAuthControls:!0}),s(document.getElementById(`booking-sidebar-mount`));var c=document.getElementById(`booking-list`),l=t({requireAuth:!0,loginRedirect:`../login.html`}),u=await n();function d(){return new Date().toISOString().split(`T`)[0]}async function f(){let e=await r(u,d());if(e.length===0){c.innerHTML=`<p>No bookings for today</p>`;return}c.innerHTML=``,e.forEach(e=>{let t=o(e.datetime);if(!document.getElementById(t)){let n=document.createElement(`div`);n.textContent=a(e.datetime),n.id=t,n.className=`booking-timeslot-heading`,c.appendChild(n)}let n=document.createElement(`div`);n.className=`booking-list-item-card`,n.innerHTML=`
