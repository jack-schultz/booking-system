import{n as e,t}from"./footer-CeiLeDeu.js";import"./register-BgmyEqJt.js";import{o as n}from"./accounts-CAIbdN4Z.js";import{n as r,r as i}from"./accountSwitcher-DjqSVm1Z.js";import{n as a,t as o}from"./db-iPnXzGMh.js";import{d as s,p as c,t as l}from"./bookings-B1SyF0II.js";e(document.getElementById(`site-navbar-mount`),{basePath:`../`,showAuthControls:!0,showSyncIndicator:!0}),t(document.getElementById(`site-footer-mount`),{basePath:`../`});var u=document.getElementById(`metrics-header`),d=document.getElementById(`metrics-notice`),f=document.getElementById(`metrics-table`),p=i({requireAuth:!0,loginRedirect:`../login.html`,onSwitch:()=>S()}),m=await a(),h=0,g=null;document.getElementById(`metrics-week-left`).addEventListener(`click`,()=>{--h,S()}),document.getElementById(`metrics-week-right`).addEventListener(`click`,()=>{h+=1,S()});function _(e,t){let n=new Date(t);return n.setDate(n.getDate()-1),`${e.toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`,month:`short`})} - ${n.toLocaleDateString(`en-AU`,{weekday:`short`,day:`numeric`,month:`short`,year:`numeric`})}`}function v(e){let{total_pax:t,adult_pax:n,child_pax:r,hc_pax:i}=e;return`
